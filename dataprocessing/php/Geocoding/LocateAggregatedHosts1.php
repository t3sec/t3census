...
$selectQuery = 'SELECT domain_id,domain_name,skipped '
    .  'FROM reg_domain '
    .  'WHERE skipped=0 AND (domain_id % 2 = 1) AND latitude IS NULL AND longitude IS NULL AND location IS NULL AND domain_suffix NOT LIKE \'de\' AND domain_suffix NOT LIKE \'fr\' AND domain_suffix NOT LIKE \'at\' '
